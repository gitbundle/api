...
func encodeListOptions(opts api.ListOptions) string {
	params := url.Values{}
	if opts.Page != 0 {
...
func encodeIssueListOptions(opts api.IssueListOptions) string {
	params := url.Values{}
	if opts.Page != 0 {
		params.Set("page", strconv.Itoa(opts.Page))
	}
...
func encodePullRequestListOptions(opts api.PullRequestListOptions) string {
	params := url.Values{}
	if opts.Page != 0 {
		params.Set("page", strconv.Itoa(opts.Page))
	}
...
func convertAPIURLToHTMLURL(apiURL string, tagName string) string {
	// "url": "https://try.magit.com/api/v1/repos/octocat/Hello-World/123",
	// "html_url": "https://try.magit.com/octocat/Hello-World/releases/tag/v1.0.0",
...
func encodeMilestoneListOptions(opts api.MilestoneListOptions) string {
	params := url.Values{}
	if opts.Page != 0 {
		params.Set("page", strconv.Itoa(opts.Page))
	}
