...
// package impl implements a Gogs client.
package impl
...
func TestClient(t *testing.T) {
	...
	if got, want := client.BaseURL.String(), "https://example.gitbundle.com/"; got != want {
		t.Errorf("Want Client URL %q, got %q", want, got)
	}
}

func TestClient_Base(t *testing.T) {
	client, err := New("https://example.gitbundle.com/v1")
	if err != nil {
		t.Error(err)
	}
	if got, want := client.BaseURL.String(), "https://example.gitbundle.com/v1/"; got != want {
		t.Errorf("Want Client URL %q, got %q", want, got)
	}
}
...
func testPage(res *api.Response) func(t *testing.T) {
