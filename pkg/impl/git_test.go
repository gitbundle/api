...
func TestGitFindCommit(t *testing.T) {
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/magit/magit/git/commits/c43399cad8766ee521b873a32c1652407c5a4630").
		Reply(200).
...
func TestGitListCommits(t *testing.T) {
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/go-magit/magit/commits").
		Reply(200).
		Type("application/json").
		File("testdata/commits.json")

	client, _ := New("https://example.gitbundle.com")
	got, _, err := client.Git.ListCommits(context.Background(), "go-magit/magit", api.CommitListOptions{})
	if err != nil {
		t.Error(err)
	}
...
func TestGitListChanges(t *testing.T) {
	client, _ := New("https://example.gitbundle.com")
	_, _, err := client.Git.ListChanges(context.Background(), "go-magit/magit", "f05f642b892d59a0a9ef6a31f6c905a24b5db13a", api.ListOptions{})
...
func TestGitFindBranch(t *testing.T) {
	...
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/go-magit/magit/branches/master").
		Reply(200).
		Type("application/json").
		File("testdata/branch.json")

	client, _ := New("https://example.gitbundle.com")
	got, _, err := client.Git.FindBranch(context.Background(), "go-magit/magit", "master")
	if err != nil {
		t.Error(err)
	}

	want := new(api.Reference)
...
func TestGitListBranches(t *testing.T) {
	...
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/go-magit/magit/branches").
		Reply(200).
		Type("application/json").
		File("testdata/branches.json")

	client, _ := New("https://example.gitbundle.com")
	got, _, err := client.Git.ListBranches(context.Background(), "go-magit/magit", api.ListOptions{})
	if err != nil {
		t.Error(err)
	}
...
func TestGitFindTag(t *testing.T) {
	...
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/go-magit/magit/git/refs/tags/v1.0.0").
		Reply(200).
		Type("application/json").
		File("testdata/tag.json")

	client, _ := New("https://example.gitbundle.com")
	got, _, err := client.Git.FindTag(context.Background(), "go-magit/magit", "v1.0.0")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGitListTags(t *testing.T) {
	...
	gock.New("https://example.gitbundle.com").
		Get("/api/v1/repos/go-magit/magit/git/refs/tags").
		Reply(200).
		Type("application/json").
		File("testdata/tags.json")

	client, _ := New("https://example.gitbundle.com")
	got, _, err := client.Git.ListTags(context.Background(), "go-magit/magit", api.ListOptions{})
	if err != nil {
		t.Error(err)
		return
	}
